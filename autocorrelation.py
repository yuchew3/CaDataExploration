...
# loads data generated in one_iter and tune xgboost on it
def load_auto_data():
    lags = 10
    length = 2 * lags
...
# New data generated just for autocorrelation
# for each pixel, calculate it's autocorrelation with lag = [1, $lags], use the autocorrelations as the data.
